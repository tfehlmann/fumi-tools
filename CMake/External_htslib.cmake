...
ExternalProject_Add(
  ...
  INSTALL_DIR ${install}
  BUILD_IN_SOURCE 1
  CONFIGURE_COMMAND cd ${src} && bash -c "CFLAGS='-fPIC -I${Zlib_cf_INCLUDE} ${HTSLIB_C_FLAGS}' LDFLAGS='-fPIC -L${ZLib_cf_LIBRARY_DIR}' ./configure --prefix=${install} --without-curses --disable-bz2 --disable-lzma --enable-libcurl=no"
